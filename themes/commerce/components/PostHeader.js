...
export default function PostHeader({ post }) {
  ...
  return (
    <div id="header" className="w-full h-90 relative md:flex-shrink-0 z-10" >
      ...
      <header id='article-header-cover'
            className="bg-black bg-opacity-70 absolute top-0 w-full h-90 py-10 flex justify-center items-center ">
